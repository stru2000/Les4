...
public class AnimalMain {
    ...
    static void main(String[] args) {
        ...
        Lion Simba = new Lion("Simba","Male","Savanna1","Eergisteren", "Kenia", 7);
        Dog Bruce = new Dog("Bruce","Male","Boris Becker", "Lobster", "Border Collie");



        IO.println("--- Test Wild Animal (Lion) ---");
        Simba.sleep();
        Simba.eat("a zebra leg");
        Simba.makeSound();
        IO.println(Simba.enclosureName);
        IO.println(Simba.enclosureName.length());

        IO.println("--- Test Wild Animal (Lion) ---");
        Bruce.move();
        Bruce.eat("de kat van de buren");
        IO.println(Bruce.favoriteFood);
